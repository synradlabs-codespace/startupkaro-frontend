  ...
  return (
    <main className="min-h-screen bg-canvas flex items-center justify-center px-6 py-12">
      ...
      <div className="relative w-full max-w-md">
        <Link href="/" className="inline-flex items-center gap-2 text-xs text-stone hover:text-slate transition-colors mb-10 font-mono tracking-widest uppercase">
          ← Back
        </Link>
        ...
        <div className="border border-hairline rounded-2xl p-10 bg-canvas shadow-sm">
          <div className="mb-8">
            ...
            <h1 className="text-4xl text-ink font-serif font-normal">Create account</h1>
            <p className="mt-2 text-sm text-graphite font-sans">Join StartupKaro and explore our services.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-2 py-3.5 rounded-xl text-sm font-mono tracking-widest uppercase transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed text-white bg-storm-deep"
            >
          ...
          <div className="mt-6 pt-6 border-t border-hairline text-center">
            <Link href="/customer/login" className="text-xs text-stone hover:text-slate transition-colors font-sans">
