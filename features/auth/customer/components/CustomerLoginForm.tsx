            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="border border-gray-200 rounded-2xl p-10 bg-white shadow-sm">
                    <div className="mb-8">
                        ...
                        <h1 className="text-4xl text-black font-serif font-normal">Welcome back</h1>
                    ...
                    <div className="mt-6 pt-6 border-t border-gray-100 flex flex-col gap-2 items-center">
                        <Link href="/customer/register" className="text-xs text-gray-400 hover:text-gray-600 transition-colors font-sans">
                            Don't have an account? Register
                        </Link>
                        <Link href="/customer/reset-password" className="text-xs text-gray-400 hover:text-gray-600 transition-colors font-sans">
                            Forgot password?
                        </Link>
                    </div>
                </div>
