    ...
    <main className="min-h-screen bg-white flex items-center justify-center px-6">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="border border-gray-200 rounded-2xl p-10 bg-white shadow-sm">
          <div className="mb-8">
            <p className="text-xs tracking-[0.3em] uppercase font-mono mb-2 font-medium text-[var(--color-indigo)]">
              StartupKaro
            </p>
            <h1 className="text-4xl text-black font-serif font-normal">Employee Portal</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-2 py-3.5 rounded-xl text-sm font-mono tracking-widest uppercase transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed text-white bg-(--color-accent-employee)"
            >
