    ...
    <main className="min-h-screen bg-canvas flex items-center justify-center px-6">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="border border-hairline rounded-2xl p-10 bg-canvas shadow-sm">
          <div className="mb-8">
            <p className="text-xs tracking-[0.3em] uppercase font-mono mb-2 font-medium text-primary-brand">
              StartupKaro
            </p>
            <h1 className="text-4xl text-ink font-serif font-normal">Employee Portal</h1>
