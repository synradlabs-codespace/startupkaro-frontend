            ...
            <div className="flex-1 p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="rounded-2xl border border-gray-200/60 bg-white/70 backdrop-blur-sm shadow-sm p-6">
                        <div className="flex items-center gap-2 mb-5">
                            <div className="h-7 w-7 rounded-lg bg-[deep-green]/10 flex items-center justify-center">
                                <BarChart3 className="h-3.5 w-3.5 text-[deep-green]" />
                            </div>
                            <div>
                                ...
                                return (
                                    <div key={m.month} className="flex flex-col items-center gap-1.5 flex-1">
                                        ...
                                        <div className="w-full flex-1 flex items-end">
                                            <div
                                                className="w-full rounded-t-lg bg-gradient-to-t from-[deep-green] to-[deep-green]/60 transition-all"
                        ...
                        {/* Growth badge */}
                        <div className="flex items-center justify-end gap-1.5 text-xs text-[deep-green] font-medium">
                                ...
                                return (
                                    <div key={service} className="space-y-1.5">
                                        ...
                                        <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                                            <div
                                                className="h-full rounded-full bg-gradient-to-r from-[deep-green] to-[deep-green]/60 transition-all"
                                                style={{ width: `${pct}%` }}
                                            />
                                        </div>
                                    </div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    {[
                        ...
                        { label: "Avg Order Value", value: `₹${avgOrderValue.toLocaleString("en-IN")}`, icon: IndianRupee, color: "text-[deep-green]" },
