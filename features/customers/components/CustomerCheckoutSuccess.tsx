...
function SuccessContent() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-6 bg-gradient-to-br from-orange-50/60 via-white to-amber-50/40">
            {/* Decorative blobs */}
            <div className="pointer-events-none fixed -top-24 -right-24 h-72 w-72 rounded-full bg-[coral]/10 blur-3xl" />
            <div className="pointer-events-none fixed -bottom-24 -left-24 h-72 w-72 rounded-full bg-orange-200/20 blur-3xl" />

            <div className="relative w-full max-w-md">
                <div className="rounded-3xl border border-[coral]/15 bg-white/80 backdrop-blur-sm shadow-xl overflow-hidden">
                    {/* Top accent */}
                    ...
                    <div className="px-8 pt-10 pb-8 text-center space-y-5">
                        ...
                        <div className="flex justify-center">
                            <div className="relative">
                                <div className="h-20 w-20 rounded-full bg-gradient-to-br from-[coral]/20 to-orange-200/30 flex items-center justify-center">
                        ...
                        {/* Info pill */}
                        <div className="inline-flex items-center gap-2 bg-[coral]/8 border border-[coral]/15 text-[#d4720a] text-xs font-medium px-4 py-2 rounded-full">
