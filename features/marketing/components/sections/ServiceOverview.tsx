        ...
        <section className="py-10 border-b border-hairline">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="max-w-3xl">
                    <h2 className="text-2xl md:text-3xl font-display font-semibold tracking-tight text-ink mb-4">Overview</h2>
                    <p className="text-sm text-slate leading-relaxed">{service.overview}</p>
                </div>
            </div>
        </section>
    );
