        ...
        <main>
            ...
            <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-14 space-y-14">
                ...
                {job.whatYoullDo && job.whatYoullDo.length > 0 && (
                    <section>
                        <h2 className="font-serif text-2xl text-gray-900 font-normal mb-6">
                ...
                {job.requirements && job.requirements.length > 0 && (
                    <section>
                        <h2 className="font-serif text-2xl text-gray-900 font-normal mb-5">
                            Requirements
                        </h2>
